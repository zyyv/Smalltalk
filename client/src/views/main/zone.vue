<template>
  <div class="zone">
    <div class="zone-bg">
      ...
      <div class="user">
        <span class="name">chriszhu</span>
        <Avatar
          radius=".5rem"
          width="6rem"
          height="6rem"
          :online="false"
          src="https://preview.webpixels.io/purpose-application-ui-kit/assets/img/theme/light/img-1-800x600.jpg"
        />
      </div>
    </div>
    <div class="content">
      <div class="zonelist">
        <div v-for="i in 3" :key="i" class="zoneitem">
          <Avatar
            style="flex: 0 0 5rem; font-size: 0; margin-right: 1.3rem"
            radius=".5rem"
            width="5rem"
            height="5rem"
            :online="false"
          ...
          <div class="wrapper">
            ...
            <div class="body">
              <div class="text">
                啊大苏打啊空间打开拉萨就的卡拉时间看见刚开始的韩国进口的话估计还得更好的疯狂进攻和大家开个会的反馈和顾客的结果和健康的风华高科接电话发给
              </div>
              <div class="imgList">
                <div class="imgItem" v-for="item in Math.floor(Math.random() * 10)" :key="item"></div>
            ...
            <div class="foot">
              <div class="likes">
                <div class="city">
                  ...
                  <span style="margin-left: 0.5rem">成都市</span>
                </div>
                <a-tooltip overlayClassName="zoneTooltip" trigger="click" arrowPointAtCenter placement="left">
                  <template #title>
                    <div class="tips">
                      <div class="tipItem">
                        <svg
              ...
              <div class="comments">
                ...
                <div class="body">
                  <div>
                    <span class="name">哈哈哈</span><span>：这是我的评论</span>
                  </div>
                  <div>
                    <span class="name">呵呵呵</span
                    ><span
                      >：这是我的评论这是我的评论这是我的评论这是我的评论这是我的评论</span
                    >
                  </div>
                  <div>
                    <span class="name">哈哈哈</span><span>回复</span
                    ><span class="name">呵呵呵</span><span>：这是我的评论</span>
                  </div>
                </div>
              </div>
            </div>
